		...
		$(document).ready(function() {
			...
			$("#form1").validate({
				...
				messages: {
					...
					address: {
						minlength: "Category Description must be at least 3 characters long",
						maxlength: "Category Description must be at least 3 characters long"
					}
				}
			});
		});
			...
			<div class="side-content fr">
				<div class="content-module">
					...
					<div class="content-module-main cf">
						<?php
						// Gump is a library for validation
						...
						if (isset($_POST['name'])) {
							...
							if ($validated_data === false) {
								...
								if ($count == 1) {
									...
									if ($db->query("INSERT INTO category_details (category_name, category_description) VALUES ('$name', '$address')")) {
						...
						<form name="form1" method="post" id="form1" action="">
							...
							<table class="form" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input name="name" placeholder="ENTER CATEGORY NAME" type="text" id="name" maxlength="200" class="round default-width-input" value="<?php echo !empty($name) ? $name : ''; ?>" /></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								...
								<tr>
									<td>Address:</td>
									<td><textarea name="address" placeholder="ENTER DESCRIPTION" cols="8" class="round full-width-textarea"><?php echo !empty($address) ? $address : ''; ?></textarea></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
